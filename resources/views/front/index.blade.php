    ...
    <div class="w-full relative">
        <div class="swiper default-carousel">
            ...
            <div class="absolute top-1/2 left-2 sm:left-4 -translate-y-1/2 z-10">
                <button
                    class="button-prev group border border-amber-600 w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center hover:bg-[#CAB882] transition duration-200 bg-white">
            ...
            <div class="absolute top-1/2 right-2 sm:right-4 -translate-y-1/2 z-10">
                <button
                    class="button-next group border border-amber-600 w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center hover:bg-[#CAB882] transition duration-200 bg-white">
                    <svg class="w-4 h-4 text-amber-600 group-hover:text-white" fill="none" stroke="currentColor"
                        stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('front.category.products', $category->id) }}">
                        <div
                            ...
                            <div class="my-2 flex justify-center">
                                <button
                                    class="bg-[#CAB882] hover:bg-amber-600 text-white font-semibold py-2 px-6 rounded-lg shadow-md flex items-center gap-2 transition duration-300">
                    ...
                    <div class="p-4 flex flex-col flex-grow">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('product.details', $product->id) }}">
                                <button
                                    class="bg-[#CAB882] hover:bg-amber-600 text-white px-4 py-2 rounded-lg transition focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-opacity-50">
                                    View Details
                                </button>
                            </a>
                        </div>
 ...
 <section class="py-12 bg-white">
    <div class="container mx-auto px-4">
        ...
        <div class="flex flex-wrap justify-center gap-3 mb-10">
            <button class="tab-btn px-4 py-2 bg-[#CAB882] text-white rounded-full active-tab" data-category="all">All</button>
        ...
        <div class="text-center mt-8">
            <button id="viewMoreBtn"
                class="px-6 py-2 bg-[#CAB882] text-white rounded-full hover:bg-amber-600 transition">
                View More
            </button>
        </div>
    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="mt-1 text-gray-600">GOPALI CHOWK,
                                    ARRAH , BIHAR - 802301</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <a href="mailto:contact@example.com"
                                    class="mt-1 text-amber-600 hover:text-amber-800">  bbbjewellers@gmail.com </a>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <a href="tel:8707656944" class="mt-1 text-amber-600 hover:text-amber-800"> 6287005000</a>
                                <br>
                                {{-- <a href="tel:9389859821" class="mt-1 text-amber-600 hover:text-amber-800">6287005000</a> --}}
                                <p class="mt-1 text-gray-500 text-sm">Mon-Sat, 11:00am-7:00pm <br> Sunday, Closed
                                </p>
                            </div>
                        </div>
                    ...
                    <form id="contactForm" method="POST" data-url="{{ route('contact.store') }}" class="space-y-6">
                        ...
                        <div class="flex items-center justify-center">
                            <button id="submitBtn" type="submit"
                                class="bg-[#CAB882] hover:bg-amber-700 text-white font-semibold py-3 px-8 rounded-full shadow-lg transition duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 flex items-center justify-center"
                                disabled>
