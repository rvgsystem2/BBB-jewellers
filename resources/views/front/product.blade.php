     ...
     `           <div class="p-5 flex flex-col flex-grow">
                    ...
                    <div class="flex justify-between items-center mt-auto">
                        ...
                        <a href="{{ route('product.details', $product->id) }}">
                            <button
                                class="bg-[#CAB882] hover:bg-amber-600 text-white text-sm px-4 py-2 rounded-lg transition focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-opacity-50">
                                View Details
                            </button>
                        </a>
                    </div>
