        ...
        <div>
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-start gap-4 mb-6">
                ...
                <a href="tel:+918707656944"
                   class="flex items-center justify-center w-full sm:w-auto bg-[#CAB882]hover:bg-amber-700 text-white font-semibold py-3 px-6 rounded-xl shadow transition duration-300">
        ...
        @foreach($relatedProducts as $related)
            <div class="group relative shadow-lg p-4 rounded-lg border border-gray-100">
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('product.details', $related->id) }}">
                        <button
                            class="bg-[#CAB882] hover:bg-amber-600 text-white px-4 py-2 mt-2 rounded-lg transition focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-opacity-50">
                            View Details
                        </button>
                    </a>
                </div>
